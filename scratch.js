                    ...
                    <div class="bg-slate-800/90 p-3 rounded-xl border border-emerald-500/40 shadow-lg">
                        <div class="flex justify-between items-center mb-1">
                            <span class="text-xs font-bold uppercase text-emerald-400 flex items-center gap-1.5">
                                <i class="fa-solid fa-star"></i> 1. Range 1 Selection
                            </span>
                        ...
                        <div class="flex gap-2 items-center">
                            <input type="text" id="s16-input-pos" value="C3:E5" class="w-24 bg-slate-900 border border-slate-700 rounded-lg px-2 py-1 text-sm font-mono text-emerald-400 font-bold focus:outline-none focus:border-emerald-400 uppercase text-center" placeholder="e.g. C3:E5">
                            ...
                            <span class="text-[11px] text-slate-400">Primary block</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-800/90 p-3 rounded-xl border border-cyan-500/40 shadow-lg">
                        <div class="flex justify-between items-center mb-1">
                            <span class="text-xs font-bold uppercase text-cyan-400 flex items-center gap-1.5">
                                <i class="fa-solid fa-shapes"></i> 2. Range 2 Selection
                            </span>
                        ...
                        <div class="flex gap-2 items-center">
                            <input type="text" id="s16-input-neg" value="G7:I8" class="w-24 bg-slate-900 border border-slate-700 rounded-lg px-2 py-1 text-sm font-mono text-cyan-400 font-bold focus:outline-none focus:border-cyan-400 uppercase text-center" placeholder="e.g. G7:I8">
                            <button id="s16-mode-neg-btn" onclick="setS16DragMode('neg')" class="px-2.5 py-1 bg-slate-700 hover:bg-cyan-700 text-white rounded-lg text-xs font-bold transition-colors flex items-center gap-1">
                                <i class="fa-solid fa-hand-pointer"></i> Drag
                            </button>
                            <span class="text-[11px] text-slate-400">Secondary block</span>
                        </div>
                    </div>
                </div>
            ...
            window.setS16DragMode = function(mode) {
                ...
                if (mode === 'pos') {
                    if (badge) {
                        ...
                        badge.textContent = '🟢 Range 1 Selection';
                    }
                    ...
                    if (negBtn) negBtn.className = 'px-2.5 py-1 bg-slate-700 hover:bg-cyan-700 text-white rounded-lg text-xs font-bold transition-colors flex items-center gap-1';
                } else {
                    if (badge) {
                        badge.className = 'px-2 py-0.5 rounded-full text-xs font-bold bg-cyan-500/20 text-cyan-400 border border-cyan-500/30';
                        badge.textContent = '🔵 Range 2 Selection';
                    }
                    ...
                    if (negBtn) negBtn.className = 'px-2.5 py-1 bg-cyan-600 text-white rounded-lg text-xs font-bold transition-colors flex items-center gap-1 ring-2 ring-cyan-400';
                }
            };
